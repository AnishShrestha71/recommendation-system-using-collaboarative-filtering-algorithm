...
<html>
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li>
          <form class="d-flex "  style="margin-left: 250px;" method="POST" action="search_result.php">
            <input type= "search" name="subject" id="subject"  class="form-control me-2" placeholder="Location of student">
      ...
      <div class="mx-3">
      <a style="text-decoration:none" class=" text-light" href="update.php?location=<?php  echo $uloc ?>&email=<?php  echo $uemail ?>&exp=<?php  echo $uexp ?>&subject=<?php  echo $usub ?>">
